      ...
      body: Padding(
        ...
        child: Center(
          child: Column(
            ...
            children: [
              Text('$currentUserName total expenses: $currentUserTotal euros',
                style: const TextStyle(fontSize: 20.0)),
              Text('$otherUserName total: $otherUserTotal euros',
                style: const TextStyle(fontSize: 20.0)),
              const SizedBox(height: 20.0),
              Text('$higherPayerName has a positive balance of $expenseDifferenceFinal euros',
